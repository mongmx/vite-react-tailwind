  ...
  return (
    <div
      className={`
        ${props.className} 
        ${defaultClass} 
        ${props.type == 'info' ? 'bg-blue-100 text-blue-700' : ''} 
        ${props.type == 'success' ? 'bg-green-100 text-green-700' : ''} 
        ${props.type == 'warning' ? 'bg-yellow-100 text-yellow-700' : ''} 
        ${props.type == 'danger' ? 'bg-red-100 text-red-700' : ''}
      `}
      role="alert"
    >
